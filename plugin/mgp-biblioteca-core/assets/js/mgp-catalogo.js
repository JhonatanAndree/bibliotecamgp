 ...
 *
 * Identificación del chip de categoría: ahora que el sitio usa Elementor
 * PRO, cada chip lleva un atributo personalizado data-mgp-categoria con el
 * slug de la taxonomía directo (ej. data-mgp-categoria="contabilidad") —
 * eso se configura en el panel Avanzado > Atributos personalizados de
 * cada widget, sin depender de nombres de clase mágicos.
 */
( function () {
	'use strict';
